...
public class Disease {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		table.setSymptom2(symptom2);
		table.setSymptom3(symptom3);
		ArrayList<String> prec=DiseaseDao.immprec(table);
		request.setAttribute("precautions", prec);
		request.getRequestDispatcher("/WEB-INF/patient/precaution.jsp").forward(request, response);
	}
}
